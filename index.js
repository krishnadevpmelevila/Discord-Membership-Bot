    ...
    if (message.author.id != '907633615599452160' && message.author.id!='707101869964656723' && message.content.toLowerCase() != 'clearchat' && message.channel.id!='909278509552267274') {
        ...
        axios.post(process.env.API_URL+'/login', {
            ...
            if (response.data.activated != true) {
                ...
                message.guild.channels.cache.get('909278509552267274').send(`<@${message.author.id}> Please verify your account first. Check your email for the verification code.  If you are once verified and now seeing this message, Then it seems the admin had deactivated your membership. Check the reason with <@707101869964656723>`)
